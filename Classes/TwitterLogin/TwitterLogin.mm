		...
		case kTableSectionOne: 
		{
			...
			switch (indexPath.row)
			{
				case kTableItemName:
					...
					//m_pUserName.text = app.m_szTwitUserName;
				...
				case kTableItemPassword:
					...
					//m_pPassword.text = app.m_szTwitPass;
...
//			//Creating Switch 
//			
//			UISwitch* btn = [[[UISwitch alloc] initWithFrame:CGRectMake(rect.size.width - 200, 9, 94, 27)] autorelease];
//			if(UI_USER_INTERFACE_IDIOM() != UIUserInterfaceIdiomPhone)
...
//			if(UI_USER_INTERFACE_IDIOM() != UIUserInterfaceIdiomPhone)
//			{
//				btn.frame = CGRectMake(768.0 - 464.0, 9, 94, 27);
//			}
//			switch (indexPath.row)
//			{
...
*/
        ...
        [alert setTitleText:@"Message" : @"Can't Sign."];
...
//    {
//        RolePlayAppDelegate* appDelegate = [UIApplication sharedApplication].delegate;
...
//    }
	...
	app.m_szTwitPass = m_pPassword.text;
	app.m_szTwitUserName = m_pUserName.text;
